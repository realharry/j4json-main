...
import static j4json.parser.core.TokenPool.TOKEN_EOF;
...
import j4json.parser.core.CharBuffer;
import j4json.parser.core.CharQueue;
import j4json.parser.core.ErrorContext;
import j4json.parser.core.JsonToken;
import j4json.parser.core.TokenPool;
import j4json.parser.core.TokenTypes;
import j4json.parser.exception.JsonTokenizerException;
import j4json.parser.exception.UnexpectedEndOfStreamException;
import j4json.parser.exception.UnexpectedSymbolException;
...
import j4json.util.LiteralUtil;
...
public abstract class AbstractJsonTokenizer implements TraceableJsonTokenizer, LookAheadJsonTokenizer
{
    ...
    //    which makes it possible that the j4json parser can always fail, potentially...
